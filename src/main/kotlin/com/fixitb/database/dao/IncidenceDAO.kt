...
interface IncidenceDAO {
    ...
    suspend fun updateIncidenceById(incidenceId: Int, device: String, image: String, description: String, status: String, classNum: Int, userAssigned: String, codeMain: String, codeMovistar: Int, title: String): Boolean
